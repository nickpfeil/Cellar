- name: 'Create directory for Node'
  file:
    path: /Users/Nick/brew/lib/nodejs
    state: directory
...
- name: 'Copy node to directory created earlier'
  command: "mv {{ output_dir }}/{{ nodejs_path }} /Users/Nick/brew/lib/nodejs/{{nodejs_path}}"
...
- vars:
    #node_bin_path: "/Users/Nick/brew/lib/nodejs/node-v{{nodejs_version}}/bin"
    node_bin_path: "/Users/Nick/brew/lib/nodejs/{{ nodejs_path }}/bin"
