...
def which_cmdfile():
    locations = [
        ...
        # bsd, solaris
        '/Users/Nick/brew/etc/nagios/nagios.cfg',
        # groundwork it monitoring
        '/Users/Nick/brew/groundwork/nagios/etc/nagios.cfg',
        # open monitoring distribution
        '/omd/sites/oppy/tmp/nagios/nagios.cfg',
        # ???
        '/Users/Nick/brew/nagios/etc/nagios.cfg',
        '/Users/Nick/brew/nagios/nagios.cfg',
        '/opt/nagios/etc/nagios.cfg',
        '/opt/nagios/nagios.cfg',
        # icinga on debian/ubuntu
        '/etc/icinga/icinga.cfg',
        # icinga installed from source (default location)
        '/Users/Nick/brew/icinga/etc/icinga.cfg',
    ]
