...
requirements:
    - php
    - composer installed in bin path (recommended /Users/Nick/brew/bin)
notes:
...
def composer_command(module, command, arguments="", options=None, global_command=False):
    ...
    if module.params['executable'] is None:
        php_path = module.get_bin_path("php", True, ["/Users/Nick/brew/bin"])
    else:
        php_path = module.params['executable']

    composer_path = module.get_bin_path("composer", True, ["/Users/Nick/brew/bin"])
