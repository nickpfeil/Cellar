...
class ServiceDocumentLiteralMessageContainer(ServiceContainerBase,
    ...
    def _setContent(self):
        ...
        #  File "/Users/Nick/brew/python/lib/python2.4/site-packages/ZSI/generate/containers.py", line 625, in _setContent
        #    kw['message'],kw['prefix'],kw['typecode'] = \
        #  File "/Users/Nick/brew/python/lib/python2.4/site-packages/ZSI/generate/containers.py", line 128, in getNSAlias
        #    raise ContainerError, 'no self.ns attr defined in %s' % self.__class__
